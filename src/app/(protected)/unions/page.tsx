...
export default function UnionsPage() {
    ...
    const handleCreate = async () => {
        ...
        try {
            const newUnionId = await createUnion(createName, user.uid, createLocation, createIndustry, createPublic);
            setCreateName("");
            setCreateLocation("");
            setCreateIndustry("");
                    ...
                    <TabsContent value="create">
                        ...
                        <div className="max-w-md mx-auto mt-12 p-6 border rounded-xl bg-card">
                            ...
                            <div className="space-y-4">
                                ...
                                />
                                <input
                                    placeholder="Industry (e.g. Healthcare, Tech)"
                                    className="w-full p-2 border rounded-md"
                                ...
                                <div className="flex items-center gap-2">
                                    <input
                                        ...
                                        className="h-4 w-4"
                                    />
                                    <label htmlFor="isPublic" className="text-sm">Make Discoverable (Public)</label>
                                </div>
